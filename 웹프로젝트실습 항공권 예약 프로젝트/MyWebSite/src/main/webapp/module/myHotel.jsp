...
<section id="main">
	...
	<section id="category">
		<h3>나의 예약</h3>
		<a href="index.jsp?CONTENTPAGE=myFlight.jsp"><input type="button" value="항공"></a>
        <a href="index.jsp?CONTENTPAGE=myHotel.jsp"><input class="selected" type="button" value="숙박" ></a>
